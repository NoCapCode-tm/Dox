      ...
      <main className="step5-main">
        ...
        <div className="step5-form-card">
          ...
          <div className="step5-form-grid">
            ...
            <FormField label="GitHub Profile" forTechRoles>
              <TextInput
                value={form.githubProfile}
                onChange={(v) => handleChange('githubProfile', v)}
...
const SelectInput = ({ value, onChange, options, placeholder }) => {
  ...
  return (
    <div className="step5-custom-select-container" ref={containerRef}>
      <div 
      ...
      {isOpen && (
        <div className="step5-custom-select-dropdown">
          {options.map((opt) => (
            <div 
              key={opt} 
              className={`step5-custom-select-option ${value === opt ? 'selected' : ''}`}
              onClick={() => {
                onChange(opt);
                setIsOpen(false);
              }}
