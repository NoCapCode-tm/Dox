      ...
      <div className="w-full px-4 md:px-[64px] mt-[24px] relative z-10">
        ...
        >
          <div className="flex items-center justify-between w-full">
            ...
            <NavItem label="System Info" icon={<SystemIcon />} active />
      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 md:px-[111px] pt-[48px] pb-[80px] relative z-10">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-[230px] gap-y-[24px]">
            ...
            <FormField label="Primary Device Type" required>
              <SelectInput
            ...
            <FormField label="Internet Reliability">
              <SelectInput
        ...
        <div className="flex justify-between items-center mt-[32px]">
          ...
          >
            <span className="text-[16px] font-medium text-white leading-[24px]">Next: System Details</span>
            <ArrowRightIcon />
          </button>
        </div>
...
export default Step7SystemInfo;
